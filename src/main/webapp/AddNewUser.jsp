...
<head>
    ...
    <title>Cyber Dojo | Admin Add New User</title>
    ...
    <div class="row">
        <div class="col-lg-12">
            <main class="form-signin" style="margin-left: 35%; margin-right:35%;">
                <form class=" text-dark text-center" action="AdminAddNewUserServlet" method="post">

                    <b><h1 class="h3 mb-3 fw-normal text-white">Add New User</h1></b>
